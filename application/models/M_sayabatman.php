...
defined('BASEPATH') OR exit('No direct script access allowed');
  ...
  Class M_sayabatman extends CI_Model
  {
	...
	public function addBook($data)
	{
		...
		$query =
		"
			INSERT INTO book (title_b, no_isbn_b, writer, pages, date_published, language_b, photo_cover_b, description_b)
			VALUES ('".$data['judulbuku']."','".$data['isbn']."','".$data['pengarang']."','".$data['halaman']."','".$data['cetakan_pertama']."',
			'".$data['bahasa']."','".$data['cover']."','".$data['sinopsis']."');
		";
