			...
			<div class="custom-container text-center">
				<ul class="nav nav-pills nav-stacked">
					<li role="presentation"><a href="<?php echo base_url()?>mybooks/add">Add Book</a></li>
				  ...
				  <li role="presentation"><a href="<?php echo base_url()?>mybooks/manager/">Manage Books</a></li>
				</ul>
			</div>
